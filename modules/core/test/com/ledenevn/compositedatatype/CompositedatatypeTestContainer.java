...
public class CompositedatatypeTestContainer extends TestContainer {

    public CompositedatatypeTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/ledenevn/compositedatatype/app.properties",
    ...
    public static class Common extends CompositedatatypeTestContainer {

        public static final CompositedatatypeTestContainer.Common INSTANCE = new CompositedatatypeTestContainer.Common();
